     ...
     <nav className="z-depth-0 ">
        <div className="nav-wrapper white">
            ...
            <ul id="nav-mobile" className="right hide-on-med-and-down caveat-bold grey-text text-darken-2">
                <li><a className="btn-flat caveat-bold purple-text text-lighten-4 navbtn btnbtn" href="#about"
                ...
                <li><a className="btn-flat caveat-bold pink-text text-accent-1 navbtn btnbtn" href="#projects"
