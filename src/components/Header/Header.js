  ...
  return (
    <div >
     <nav className="z-depth-0 ">
        <div className="nav-wrapper white">
            <a href="index.html" className="brand-logo left caveat-bold hide-on-med-and-down grey-text text-darken-2"> Ian Fletcher || Developer</a>
    ...
    <div className="container center">
        <ul className="brand-logo center hide-on-large-only show-on-medium-and-down caveat left-align">
            <li><a className="btn-flat caveat-bold purple-text text-lighten-3 navbtn" href="#about" id="aboutbtn"
            onClick={() => setPageState(componentCluster[1])}>ABOUT</a>
            </li>
            <li><a className="btn-flat caveat-bold pink-text text-accent-1 navbtn" href="#projects"
                    id="projectsbtn"
                    onClick={() => setPageState(componentCluster[2])}>PROJECTS</a></li>
            <li><a className="btn-flat caveat-bold cyan-text text-accent-3 navbtn" href="#contact"
                    id="contactbtn"
                    onClick={() => setPageState(componentCluster[3])}>CONTACT</a></li>
        </ul>
    </div>
  </div>
  );
