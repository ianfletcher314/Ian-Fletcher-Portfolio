    ...
    return (
        <div>
            ...
            <section id="contact" className="container caveat-bold center space roof">
                ...
                <a className="center grey-text text-accent-3 contact" href={resume} target="_blank"  download>
                ...
                <a className="center grey-text text-accent-3 contact" href="https://www.linkedin.com/in/ian-fletcher-a51420124/"  target="_blank">
